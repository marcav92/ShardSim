class Config():
  ...
  @classmethod
  def init(cls, **args):
    cls.block_interval = args['block_interval'] if 'block_interval' in args else 1000
    cls.intrashard_comm_delay_upper_bound = args['intrashard_comm_delay_upper_bound'] \
      if 'intrashard_comm_delay_upper_bound' in args else 60
